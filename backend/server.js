...
//     const pdfFilePath = await pdfService.createPDF(graphs, req.file.filename);
    
//     // Send file
//     res.download(pdfFilePath, 'thesis-graphs.pdf', async (err) => {
//       if (err) {
//         console.error('Error sending file:', err);
//         if (!res.headersSent) {
//           res.status(500).json({ success: false, error: 'Error downloading file' });
...
//       // Cleanup
//       const filesToClean = [req.file.path, pdfFilePath, ...graphFiles];
